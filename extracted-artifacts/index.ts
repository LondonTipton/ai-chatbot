...
export { Artifact, UIArtifact, ArtifactKind, artifactDefinitions } from './extracted-components/artifact';
...
export { Artifact as ArtifactClass, ArtifactActionContext, ArtifactToolbarContext, ArtifactToolbarItem } from './extracted-components/create-artifact';

// Hooks
export { useArtifact, useArtifactSelector, initialArtifactData } from './extracted-hooks/use-artifact';
...
export { DocumentSkeleton, InlineDocumentSkeleton } from './ui/document-skeleton';
