...
const searchStep = createStep({
  ...
  execute: async ({ inputData, runtimeContext }) => {
    ...
    try {
      ...
      console.log("[Basic Search V2] Generated variations:", enhanced.variations.length);
      console.log("[Basic Search V2] HyDE passage length:", enhanced.hydePassage.length);
      console.log(`[Basic Search V2] ⏱️ Query enhancement time: ${(enhanceEndTime - enhanceStartTime).toFixed(0)}ms`);
      ...
      console.log(`[Basic Search V2] Batch legal search: ${legalQueries.length} queries`);
      ...
      console.log(`[Basic Search V2] ⏱️  Legal search time: ${legalSearchTime.toFixed(0)}ms`);
      console.log(`[Basic Search V2] ⏱️  Total parallel search time: ${totalSearchTime.toFixed(0)}ms`);
